 ...
 */
CHangarA::CHangarA(	const glm::vec3 vec3Position,
 ...
 */
bool CHangarA::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CHangarA::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CHangarA::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CHangarA::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CHangarA::Update(const double dElapsedTime)
{
...
/**
 @brief Print Self
 */
void CHangarA::PrintSelf(void)
{
	cout << "CHangarA::PrintSelf()" << endl;
	cout << "========================" << endl;
}
