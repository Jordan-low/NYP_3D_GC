 ...
 */
CBuilding::CBuilding(	const glm::vec3 vec3Position,
 ...
 */
bool CBuilding::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CBuilding::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CBuilding::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CBuilding::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CBuilding::Update(const double dElapsedTime)
{
	...
	float fDistanceToPlayer = glm::distance(vec3Position, CPlayer3D::GetInstance()->GetPosition());
	if (fDistanceToPlayer < 10 && CPlayer3D::GetInstance()->GetHealth() < CPlayer3D::GetInstance()->GetMaxHealth())
	{
		CPlayer3D::GetInstance()->isHealing = true;
	}
...
*/
void CBuilding::PostRender(void)
{
...
/**
 @brief Print Self
 */
void CBuilding::PrintSelf(void)
{
	cout << "CBuilding::PrintSelf()" << endl;
	cout << "========================" << endl;
}
